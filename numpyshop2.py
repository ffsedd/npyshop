...
SETTINGS = {
    ...
    "hide_stats": True,
    "history_steps": 0,     # history disabled (memory full)
}
...
class mainWin(tk.Toplevel):
    ...
    def canvas_init(self):
        ...
        self.canvas = tk.Canvas(self, width=self.canvas_width,\
                                height=self.canvas_height, background="gray")
        self.canvas.pack()
...
if __name__ == '__main__':
    ...
    Fp = Path("/home/m/Dropbox/ZUMI/zakazky/1344_Vondruška/odber/foto.pdf2.jpg")
